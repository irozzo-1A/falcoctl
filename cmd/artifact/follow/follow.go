...
func NewArtifactFollowCmd(ctx context.Context, opt *options.Common) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		PreRunE: func(cmd *cobra.Command, args []string) error {
			...
			default:
				return fmt.Errorf("invalid value for --startup-behavior: %q. Allowed values are: %q, %q, %q", o.startupBehavior, follower.StartupBehaviorSkip, follower.StartupBehaviorJitter, follower.StartupBehaviorImmediate)
			}
	...
	cmd.Flags().StringVar(&o.startupBehavior, "startup-behavior", string(follower.StartupBehaviorJitter), "Startup behavior for the follower: 'skip', 'jitter', or 'immediate'.")
